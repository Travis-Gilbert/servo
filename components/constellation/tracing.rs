    ...
    impl LogTarget for servo_constellation_traits::ScriptToConstellationMessage {
        fn log_target(&self) -> &'static str {
            match self {
                ...
                Self::SetBrowsingContextName(..) => target!("SetBrowsingContextName"),
                Self::FindBrowsingContextByName(..) => target!("FindBrowsingContextByName"),
                Self::LoadUrlInBrowsingContext(..) => target!("LoadUrlInBrowsingContext"),
